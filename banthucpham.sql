...
(4, 'b', '202cb962ac59075b964b07152d234b70', 'dophuong23082003@gmail.com', 'Vũ Duy Quang', 'Hà Nội', '0123456789', '2023-08-29');
...
--
ALTER TABLE `quanly`
  MODIFY `ID_QuanLy` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `thanhvien`
  MODIFY `ID_ThanhVien` int(11) NOT NULL AUTO_INCREMENT;
